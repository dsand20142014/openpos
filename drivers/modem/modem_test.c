...
static const char * scanCom = "/dev/ttymxc1,115200,N,8,1,1";
...
int main(void)
{
		...
		OSGUI__bar_open(&comfd);
			...
			write(comfd,"ATDT015901767546\r", 16);
			sleep(10);
			if(read(comfd,inbuf,sizeof(inbuf)))
			{
				printf("read:%s\n",inbuf);
