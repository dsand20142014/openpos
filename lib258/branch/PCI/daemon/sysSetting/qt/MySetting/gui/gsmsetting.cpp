...
//add by xiongjian at 20130201
    ...
    tabOneLabel[0] = new QLabel(QString(sysSetting.key));
    ...
    tabOneLabel[1] = new QLabel(QString(sysSetting.key));
    ...
    tabOneLabel[2] = new QLabel(QString(sysSetting.key));
   // tabOneLabel[2]->setGeometry(30,60+160,170,31);
   ...
   // tabOneEdit[0]->setGeometry(40,110+160,150,30);
    ...
    tabOneLabel[3] = new QLabel(QString(sysSetting.key));
    ...
    tabOneLabel[4] = new QLabel(QString(sysSetting.key));
...
//add by xiongjian at 20130201
    ...
    {
        informationBox->setStyleSheet("QLabel{background-color:red;color:black;border:2px solid beige;}");
        informationBox->setText(tr("APN SET ERROR, PLEASE CHECK!"));
    ...
    informationBox->setText("SAVING...,WAIT PLEASE!");
    informationBox->raise();
    informationBox->show();
    ...
    informationBox->setStyleSheet("QLabel{background-color:green;color:black;border:2px solid beige;}");
