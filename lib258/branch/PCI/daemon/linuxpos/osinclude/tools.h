...
/* tlv.c */
unsigned char TLV_DecodeSAND(unsigned char *pucBuf,unsigned int uiLen, TLV *pTLV,unsigned short *puiNbr);
unsigned char TLV_AccessTagSAND(unsigned char *pucInData,unsigned int uiInLen, unsigned short uiTag,TLV *pTLV);
