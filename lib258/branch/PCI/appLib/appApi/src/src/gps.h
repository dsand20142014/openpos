...
#define SUCCESS_GPS				 0;
#define ERROR_OPEN_GPSDEV		-1;
#define ERROR_READ_GPSDEV		-2;
#define ERROR_GET_GPGGA			-3;
#define ERROR_GET_GPGSA			-4;
#define ERROR_GET_GPGSV			-5;
#define ERROR_GET_GPGLL			-6;
#define ERROR_GET_GPRMC			-7;
#define ERROR_GET_GPVTG			-8;
#define ERROR_GET_GPZDA			-9;
