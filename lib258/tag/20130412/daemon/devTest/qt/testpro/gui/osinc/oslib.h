...
#include <sand_types.h>           /* unsigned unsigned char, unsigned short and ulong types */
...
//void    Os__display(unsigned char line,unsigned char col,unsigned char *text); removed by pan.cy
...
#if 0
/* --- Time and Date --- */
void    Os__read_date_time(unsigned char *pt);
void    Os__read_date(unsigned char *pt);
void    Os__read_time(unsigned char *pt);
unsigned char   Os__write_time(unsigned char *pt);
unsigned char   Os__write_date(unsigned char *pt);
void    Os__read_date_format(unsigned char *pt_out);
void    Os__read_time_format(unsigned char *pt_out);
#endif
/* --- DELAY ---*/
...
#if 0
unsigned short Os__get_calling_param(CALLING_PARAM *pt,void *pt_out)reentrant;
void   Os__return_calling_page(CALLING_PARAM *pt,void *pt_in,unsigned short length,unsigned char status)reentrant;
unsigned char  Os__call_page(CALLING_PARAM *pt,void *pt_in,unsigned short lg_in,void *pt_out)reentrant;
#endif
...
#if 0
unsigned char   Os__infrared_init(COM_PARAM *pt);
