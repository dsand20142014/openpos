    ...
    pageIndex(0)
{
    ...
    enterFlag = false;
    //testNames << tr("1.MODULE") << tr("2.DATETIME") << tr("3.SCREEN") << tr("4.GSM")<<tr("5.GSM \nBAND")<<tr("6.KEY CLEAR")<<tr("7.WIFI")<<tr("8.EXIT");
    ...
    testIcons << tr("/daemon/image/icon/1.png") << tr("/daemon/image/icon/2.png")
              ...
              <<tr("/daemon/image/icon/screenAdjust.png")<<tr("/daemon/image/icon/6.png");
    fristFLag = true;
...
//   qDebug() << "enterFlag "<< enterFlag;
    ...
    else if((!enterFlag) && (itemName == testNames.at(4)))
    {
        ...
        aw->show();
//        GSMBandsTest *gt = new GSMBandsTest();
//        gt->show();
    ...
    else if((!enterFlag) && (itemName == testNames.at(5)))
    {
        ...
        pswDialog->setGeometry(10,80,220,130);
