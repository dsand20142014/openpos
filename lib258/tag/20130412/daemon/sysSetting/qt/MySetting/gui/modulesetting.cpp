...
void ModuleSetting::drawModuleGUI(void)
{
    ...
    tabOneLabel[0] = new QLabel("MACHINE_SERIAL_NO");
    ...
    tabOneLabel[1] = new QLabel("PINPAD_SERIAL_NO");
    ...
    gridlayout->addWidget(new QLabel("ACTIVE"),0,0);
    gridlayout->addWidget(new QLabel("DEBUG"),0,1);
    gridlayout->addWidget(new QLabel("DAEMON  VERSION"),0,2);
    ...
    gridlayout3->addWidget(new QLabel("ACTIVE"),0,0);
    gridlayout3->addWidget(new QLabel("DEBUG"),0,1);
    gridlayout3->addWidget(new QLabel("NAME  VERSION"),0,2);
