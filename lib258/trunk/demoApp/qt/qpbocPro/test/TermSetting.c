...
UCHAR	TERMSETTING_DateTime()
{
	...
	Os__clr_display(255);
	Os__GB2312_display(0,2,(PUCHAR)"Cur Date:");
	Os__GB2312_display(1,2,(PUCHAR)"(YYMMDD)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,2,(PUCHAR)"Cur Time:");
	Os__GB2312_display(1,2,(PUCHAR)" (hhmm)");
	Os__GB2312_display(2,0,aucBuff);
	...
	memcpy(&aucBuff[4],"00",2); //在税控底层环境下运行需加上此行
	Os__write_time(aucBuff);
	
	Os__clr_display(255);
	Os__GB2312_display(2,0,(PUCHAR)"Date&Time Set OK!");
...
UCHAR	TERMSETTING_TermInfo(void)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(0,2,"Terminal ID");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,2,"Merchant ID");
...
UCHAR	TERMSETTING_TermConfig(void)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Batch Capture?");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Support PBOC20?");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Communication Port");
	Os__GB2312_display(1,0,(PUCHAR)"1-COM1  2-COM2");
	Os__GB2312_display(2,0,(PUCHAR)"3-COM3");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Reader Port");
	Os__GB2312_display(1,0,(PUCHAR)"1-COM1 2-COM2");
	Os__GB2312_display(2,0,(PUCHAR)"3-COM3");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Ticket Print");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Auto Remove");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"ICC Debug");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
	...
	Os__clr_display(255);
	Os__GB2312_display(0,0,(PUCHAR)"Digital Debug");
	Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
...
UCHAR	TERMSETTING_EMVTransParam(void)
{
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Terminal Type");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:   ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"PSE Support?");
		Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Terminal Capab");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:      ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Terminal AddCapab");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Country Code");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Currency Code");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"App Ver");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,2,(PUCHAR)"Floor Limit");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD: ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,2,(PUCHAR)"  Threshold");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD: ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Traget Percent");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Max Traget Percent");
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(2,0,(PUCHAR)"Param Set OK");
		UTIL_GetKey(3);
	}
	else
		QERROR_DisplayMsg(ucResult);
...
UCHAR	TERMSETTING_TAC(void)
{
	...
	if(!ucResult)
	{
		memset(aucBuff,0x00,sizeof(aucBuff));
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Denial Code Exist");
		...
		if(tac.bDenialExist)
		{
			...
			//Os__GB2312_display(3,0,(PUCHAR)"Denial Code");
			memset(aucBuff,0x00,sizeof(aucBuff));
			strcpy((char*)aucBuff,"OLD:  ");
	...
	if(!ucResult)
	{
		memset(aucBuff,0x00,sizeof(aucBuff));
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Online Code Exist");
		...
		if(tac.bOnlineExist)
		{
			...
			//Os__GB2312_display(3,0,(PUCHAR)"Online Code");
			memset(aucBuff,0x00,sizeof(aucBuff));
			strcpy((char*)aucBuff,"OLD:  ");
	...
	if(!ucResult)
	{
		memset(aucBuff,0x00,sizeof(aucBuff));
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Default Code Exist");
		...
		if(tac.bDefaultExist)
		{
			...
			//Os__clr_display(255);
			//Os__GB2312_display(3,0,(PUCHAR)"Default Code");
			memset(aucBuff,0x00,sizeof(aucBuff));
			strcpy((char*)aucBuff,"OLD:  ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(2,2,(PUCHAR)"TAC Set OK!");
		UTIL_GetKey(3);
	}
	else
		QERROR_DisplayMsg(ucResult);
...
UCHAR	TERMSETTING_Func(void)
{
	do
	{
		...
		{
			Os__GB2312_display(0,0,"1.Terminal");
			Os__GB2312_display(1,0,"2.Function");
			Os__GB2312_display(2,0,"3.Date and Time");
			Os__GB2312_display(3,0,"4.Default Setting");
		}
		else
		{
			Os__GB2312_display(0,0,"1.终端设置");
			Os__GB2312_display(1,0,"2.功能选项");
			Os__GB2312_display(2,0,"3.日期与时间");
			Os__GB2312_display(3,0,"4.缺省设置");
		}
		switch(Os__xget_key())
		{
		case '1':
...
UCHAR	TERMSETTING_TransParam(void)
{
	do
	{
		...
		if(QConstParam.bPBOC20==FALSE)
		{
			Os__GB2312_display(1,0,"1.EMV Param");
			Os__GB2312_display(2,0,"2.Reader Param");
		}
		else
		{
			Os__GB2312_display(1,0,"1.EMV参数");
			Os__GB2312_display(2,0,"2.READER参数");
		}
...
void	TERMSETTING_LoadDefaultSetting(void)
{
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(2,0,"Default Load OK!");
		UTIL_GetKey(3);
	}
	else 
		QERROR_DisplayMsg(ucResult);
...
UCHAR	TERMSETTING_ReaderParam(void)
{
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"RCFL EXIST?");			//Reader Contactless Floor Limit Exist Flag
		Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"RCFLimit Value");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"RCTL Exist?");					//Reader Contactless Transaction Limit  Exist Flag
		Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"RCTLimit Value");				//Reader Contactless Transaction Limit
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"CVM Limit EXIST?");					//Reader CVM Required Limit  Exist Flag
		Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"CVM Limit Value");				//Reader Contactless Transaction Limit
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"Status Check?");					//Status Check Flag
		Os__GB2312_display(1,0,(PUCHAR)"(0-No 1-Yes)");
		memset(aucBuff,0x00,sizeof(aucBuff));
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(0,0,(PUCHAR)"TTQ Value");					//Terminal Transaction Qualifiers
		memset(aucBuff,0x00,sizeof(aucBuff));
		strcpy((char*)aucBuff,"OLD:    ");
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(2,0,(PUCHAR)"READER Param OK");
		UTIL_GetKey(3);
	}
	else
		QERROR_DisplayMsg(ucResult);
