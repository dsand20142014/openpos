...
UCHAR MSG_ComSendData(PUCHAR pucBuff, USHORT uiLen)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(3,2,(PUCHAR)"Send Data...");
	Os__com_flush2();
//	Os__xdelay(50);
//	Os__xdelay(5);
...
UCHAR MSG_ComRecvData(PUCHAR pBuff, USHORT *puiLen)
{
	...
	UCHAR  ucTemp,ucLRC;
	Os__clr_display(255);
	Os__GB2312_display(3,2,(PUCHAR)"Receive Data...");
...
UCHAR	MSG_FinaTransRequest(PUCHAR pRecvBuff,USHORT *puiLen)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(2,0,"Fina Request");
...
UCHAR	MSG_AuthTransRequest(PUCHAR pRecvBuff,USHORT *puiLen)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(2,0,"Auth Request");
	memset(ComPackSend,0,1024);
	ComPackSendLen=0;
...
UCHAR	MSG_TransConfirm(void)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(2,0,"Confirm");
	memset(ComPackSend,0,1024);
	ComPackSendLen=0;
...
UCHAR	MSG_ReversalRequest(void)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(2,0,"Reversal Request");
	memset(ComPackSend,0,1024);
	ComPackSendLen=0;
...
UCHAR	MSG_AdviceRequest(void)
{
	...
	Os__clr_display(255);
	Os__GB2312_display(2,0,"Online Advice");
	//Os__xdelay(100);
	memset(ComPackSend,0,1024);
	ComPackSendLen=0;
...
UCHAR	MSG_UpdateParam(void)
{
	...
	{
		Os__clr_display(255);
		Os__GB2312_display(2,0,"Param Update OK!");
		UTIL_GetKey(3);
	}
	else 
		QERROR_DisplayMsg(ucResult);
