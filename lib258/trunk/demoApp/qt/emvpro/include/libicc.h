...
#define  ModifyWareList		0xb4	/* 修改商品销售表 */
    ...
    LIBICCDATA char bRecvByte;
     ...
     extern unsigned char aucCardRecvBuf[256];
    ...
    /* timer.c */
     extern unsigned char aucCtrlTimer[7];

    /* 发票部分信息 */
    LIBICCDATA unsigned short usRefInvSectNo;			/* 退货时原来的发票序号 */
    extern unsigned char ucRefInvSectNo;			/* 退货时原来的发票序号 */

    extern unsigned char ucReaderNO;
