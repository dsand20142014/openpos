...
//              <<tr("/daemon/image/icon/screenAdjust.png")<<tr("/daemon/image/icon/5.png")<<tr("/daemon/image/icon/6.png");
    ...
    testNames << tr("1.MODULE") << tr("2.DATETIME") << tr("3.PERSONALITY \nSETTING") << tr("4.GSM")<<tr("5.KEY CLEAR")<<tr("6.SCREEN \nADJUST")
              <<tr("7.MODULE \nACTIVE")<<tr("8.WIFI")
             <<tr("9.WIFI \nSUSPEND")<<tr("1.MAC \nWINDOW")<<tr("2.EXIT");
    ...
    testIcons << tr("/daemon/image/icon/1.png") << tr("/daemon/image/icon/2.png")
             ...
             << tr("/daemon/image/icon/5.png")<<tr("/daemon/image/icon/WIFI_SUSPEND.png")<<tr("/daemon/image/icon/6.png")
             <<tr("/daemon/image/icon/6.png");
...
void ParallaxHome::screenFunc()
{
    ...
    connect(ss,SIGNAL(destroyed()),this,SLOT(update()));
...
void ParallaxHome::macWinFunc()
{
        MacWin *mw = new MacWin();
        mw->show();
        connect(mw,SIGNAL(destroyed()),this,SLOT(setEnterFlag()));
}
