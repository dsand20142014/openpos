    ...
    QWidget(parent,Qt::FramelessWindowHint)
{
    ...
    labelScreen = new QLabel(tr("PRESS THE CROSS TO ADJUST!"),this);
    labelScreen->setObjectName("labelScreen");
    labelScreen->raise();
    labelScreen->setAlignment(Qt::AlignCenter);
    labelScreen->show();
    labelScreen->setGeometry(0,0,screenW,screenH);
...
{
    if(ok)
        labelScreen->setText(tr("ADJUST SUCCESS!"));
    else
        labelScreen->setText(tr("ADJUST FAILED!"));
