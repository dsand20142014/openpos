...
KeyClearSetting::KeyClearSetting(QWidget *parent) :
    BaseForm(tr("KEY CLEAR SETTING"),parent)
{
    btnAuto =  new Button(tr(" Dynamic Key"),9);
    btnAuto->setFixedSize((160*screenWidth)/240,(40*screenHeight)/320);
...
void KeyClearSetting::slotAuto()
{
    ...
    if (box.clickedButton() == noBtn)
     ...
     showInforText(tr("CLEAR SUCCESS!"),true,15,185);
