    ...
    BaseForm(tr(" "), parent)
{
    ...
    if(hotflags)
        title->setText(tr("PRINTER HOT TEST"));
    else
        title->setText(tr("PRINTER TEST"));

    label = new QLabel(this);
    label->setAlignment(Qt::AlignCenter);
    label->setFixedWidth((130*screenWidth)/240);

    btnOne = new Button(tr("1.SINGLE TEST"),9,this);
    btnMore = new Button(tr("2.LOOP TEST"),9,this);
