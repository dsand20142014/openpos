    ...
    BaseForm(tr("BUZZER TEST"), parent)
{
    ...
    if(flags == 3){
        ...
        vbox->setSpacing(18);
        vbox->addWidget(picBeep);
        vbox->addWidget(pushButton_2);
        vbox->setContentsMargins(40,10,40,10);
        vbox->addStretch(1);
        ...
        vbox->setContentsMargins(40,60,40,10);
        vbox->addStretch(1);
        textEdit->setLayout(vbox);
        ...
        slider->setFixedSize((180*screenWidth)/240,(40*screenHeight)/320);
...
////        layout->setSpacing(10);
        ...
        hlayout->addWidget(new QLabel(tr("DARK")));
        hlayout->addWidget(new QLabel(tr("BRIGHT")));
...
//        layout->addLayout(hlayout);
        ...
        vbox->setContentsMargins(20,40,20,10);
        vbox->addStretch(1);

        textEdit->setLayout(vbox);
        textEdit->setFixedSize((220*screenWidth)/240,(200*screenHeight)/320);
