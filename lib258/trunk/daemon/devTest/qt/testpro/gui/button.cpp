    ...
    QPushButton(text, parent)
{
    ...
    setMinimumSize((102*screenWidth)/240,(36*screenHeight)/320);//102, 36);
    setMaximumSize((215*screenWidth)/240,(40*screenHeight)/320);//215, 40);
...
void Button::loadStyleSheet(const QString &sheetName, QWidget *obj)
{
    ...
    if (file.open(QFile::ReadOnly)) {
        ...
        if (obj) {
            ...
            //qDebug()<<"@@@@@@@@@@@@@@@@@@ qApp->setStyleSheet(styleSheet);";
