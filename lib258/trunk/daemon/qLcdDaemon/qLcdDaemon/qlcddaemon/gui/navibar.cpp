      ...
      naviBarCount(count)
{
    ...
    m_cursors1->setRect(x+2, 2, 8, 8);//xl
    m_cursors1->setBrush(QColor(0,30,105));//xl
...
void NaviBar::paint(QPainter * painter, const QStyleOptionGraphicsItem *option, QWidget *)
{
    painter->setBrush(QColor(0,50,125));//xl
