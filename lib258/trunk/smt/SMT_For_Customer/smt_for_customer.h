...
#define     SMT_VERSION     "SMT For Customer 1.0.4"
/*****************************************************************
  SMT For Customer 1.0.4 update at 2013.06.21 by garvey
  1.更改发送buf从1024变为2048,并且将每次休眠时间由20ms变为1ms

  SMT For Customer 1.0.3 update at 2013.04.12 by garvey
  1.缩短检查ARM机型次数到100次
