...
static irqreturn_t csi_irq_handler(int irq, void *data)
{
	...
	//if(status & BIT_SFF_OR_INT)
		//printk("STATFIFO overrun!\n");
...
void csi_enable_int(int arg)
{
	...
	cr1 |= BIT_SOF_INTEN;
	cr1 |= BIT_RF_OR_INTEN|BIT_SF_OR_INTEN;   //rx fifo  stat fifo overrun enbale
	if (arg == 1) {
