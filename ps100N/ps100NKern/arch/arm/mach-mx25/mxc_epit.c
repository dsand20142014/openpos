...
static void test_irq(void)
{
    ...
    epit_clear_ocif(EPIT1);
    epit_set_lr(EPIT1,0xFFFFFFFF);
    epit_set_cmpr(EPIT1,0xFFFFFFFF-0x4280000);
...
#if 0
    pr_alert("epit2 cr = 0x%08x\n",ioread32(epit_dev_p->epit2_cr));
    pr_alert("epit2 sr = 0x%08x\n",ioread32(epit_dev_p->epit2_sr));
    pr_alert("epit2 lr = 0x%08x\n",ioread32(epit_dev_p->epit2_lr));
    pr_alert("epit2 cmpr = 0x%08x\n",ioread32(epit_dev_p->epit2_cmpr));
    pr_alert("epit2 cnr = 0x%08x\n",ioread32(epit_dev_p->epit2_cnr));
#endif
}
...
#if 0
    request_irq(EPIT1_INT, test_int, 0, 0, 0);
    test_irq();
#endif
    return 0;
nomem:
