...
#endif
#if 1
	//640x480,zengshu,2012-7-4
	{0x3808,0x02, BYTE_LEN, 0},
	{0x3809,0x80, BYTE_LEN, 0},
	{0x380a,0x01, BYTE_LEN, 0},
	{0x380b,0xE0, BYTE_LEN, 0},
#endif

#if 0
	//320x240,zengshu,2012-7-4
	{0x3808,0x01, BYTE_LEN, 0},
	{0x3809,0x40, BYTE_LEN, 0},
	{0x380A,0x00, BYTE_LEN, 0},
	{0x380B,0xF0, BYTE_LEN, 0},
#endif
...
static const struct ov2659_i2c_reg_conf const size_320x240_tbl[] = {
	{0x3808,0x01,BYTE_LEN, 0},
	{0x3809,0x40,BYTE_LEN, 0},
	{0x380A,0x00,BYTE_LEN, 0},
	{0x380B,0xF0,BYTE_LEN, 0},
...
struct ov2659_reg ov2659_regs = {
	...
	.size_320x240_tbl = size_320x240_tbl,//add by zengshu 2012-7-4
	.size_320x240_tbl_size = ARRAY_SIZE(size_320x240_tbl)
};
