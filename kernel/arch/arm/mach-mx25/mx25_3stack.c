...
static const char fb_default_mode[] = "TM-QVGA";
...
static __init void mxc_init_pwm1(void)
{
    ...
    buzzer->pwm_addr = (unsigned long *)ioremap_nocache(PWM1_ADDRESS, 64);
...
static __init void mxc_init_pwm4(void)
{
    ...
    backlight->pwm_addr = (unsigned long *)ioremap_nocache(PWM4_ADDRESS, 64);
