 ...
 * Argument type: pointer to t_adc_convert_param.
 */
#define IMX_ADC_BUTTONPOWER   			_IOWR('p', 0xb5, int)
#define IMX_ADC_LITHIUMPOWER  			_IOWR('p', 0xb6, int)
#define IMX_ADC_PRINTEROVERHEAD      	_IOWR('p', 0xb7, int)
#define IMX_ADC_ADPTER                  _IOWR('p', 0xb8, int)
#define IMX_ADC_WIFIPW                  _IOWR('p', 0xb9, int)
 ...
 * touch screen
 */
#define DELTA_Y_MAX             500
#define DELTA_X_MAX             500
