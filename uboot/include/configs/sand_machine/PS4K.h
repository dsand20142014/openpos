...
#define	CONFIG_EXTRA_ENV_SETTINGS		                			  \
	...
	"kernel=uImage\0"						                          \
	"bootargs_base=setenv bootargs console=ttymxc4,115200 sand_machine=${sand_machine}\0"	      \
	"bootargs_nand=setenv bootargs $(bootargs) ubi.mtd=4 "			  \
		"root=ubi0:ubifs rootfstype=ubifs\0"							  \
	"bootcmd=fpga_config;run bootcmd_nand;\0"					          \
	"bootcmd_nand=run bootargs_base bootargs_nand; "					  \
		"nand read 0x80800000 0x200000 0x280000;bootm 0x80800000\0"	  \
	"load_uboot=tftpboot ${loadaddr} ${uboot}\0"                      \
	"mmc_wb= mmc rescan; fatload mmc 0 80800000 u-boot.bin;"           \
	"nand erase 0 58000; nand write 80800000 0 58000\0"                 \
	"usb_wb = usb start; fatload usb 0 80800000 u-boot.bin;"         \
	"nand erase 0 58000; nand write 80800000 0 58000\0"		\
...
#define UBOOT_IMAGE_SIZE	0x80000		
