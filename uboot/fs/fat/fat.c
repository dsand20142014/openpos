...
static int disk_read (__u32 startblock, __u32 getsize, __u8 * bufptr)
{
	if (cur_dev == NULL)
		return -1;
	//printf("in %d disk_read()  startblock:0x%x  part_offset:0x%x\n", __LINE__,startblock,part_offset);
	startblock += part_offset;
	//printf("in %d disk_read()  startblock:0x%x\n", __LINE__,startblock);
...
int fat_register_device (block_dev_desc_t * dev_desc, int part_no)
{
	...
	//printf(" in 75 fat_register_device()\n");
	...
	//printf(" in 87 fat_register_device()\n");
	...
	//printf(" in 92 fat_register_device()\n");
